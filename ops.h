...
typedef enum {
     ...
     */
    OP_FILETODOWNLOAD = 30, //utilizzato per memorizzare nella history il nome di un file da scaricare
    OP_SENDFILE     = 31, //serve per notificare al server un effettivo invio
