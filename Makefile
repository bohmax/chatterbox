...
# 
FILE_DA_CONSEGNARE=Makefile chatty.c message.h ops.h stats.h config.h  Hashtable.h\
		    connections.h listener.h listacondivisa.h albero.h Configurazione.h worker.h\
		    Configurazione.c connections.c listener.c listacondivisa.c albero.c Hashtable.c worker.c
# inserire il nome del tarball: es. NinoBixio
TARNAME=MassimoPuddu
